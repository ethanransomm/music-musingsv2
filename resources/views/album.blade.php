                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-t border-gray-700 pt-4 space-y-2 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="px-2 py-0.5 rounded text-xs font-semibold bg-gray-700 text-gray-300 border border-gray-600">
                                    {{ $album->genre }}
                                </span>
                            </div>
                        </div>
                            ...
                            <ul class="divide-y divide-gray-700">
                                @foreach($album->songs as $index => $song)
                                    <li class="px-4 py-3 flex items-center hover:bg-gray-700/50 transition group">
                                        <span class="w-8 text-sm text-gray-500 font-mono group-hover:text-green-500">{{ $index + 1 }}</span>
                                        <span class="flex-grow text-gray-200 font-medium group-hover:text-white">{{ $song->title }}</span>
